...
<pre> ## 🧑‍💻 Project Structure ``` Online-Voting-System-with-Facial-Recognition/ ├── manage.py ├── voting_app/ │ ├── models.py │ ├── views.py │ ├── urls.py │ └── templates/ ├── static/ ├── media/ └── README.md ``` </pre>
